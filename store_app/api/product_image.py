...
from store_app.database.models import ProductImage
from store_app.database.schema import ProductInputImageShema,ProductOutImageShema
...
@product_image_router.put('/{product_image.id}/',response_model=dict)
async def update_product_image(product_image_id: int, product_image: ProductInputImageShema ,
...
@product_image_router.delete('/{product_image.id}/',response_model=dict)
